...
3. **Given** посетитель сомневается в эффективности, **When** читает блок «Как помогает терапия», **Then** видит конкретные цифры (8 из 10 клиентов, снижение тревоги, нормализация сна) с пометкой «доказательный подход»
...
- **FR-009**: Блок «Как помогает терапия» MUST содержать конкретные результаты с цифрами: снижение тревоги, умение останавливать панические атаки, нормализация сна, управление стрессом; маркеры методики КПТ; социальное доказательство «8 из 10 клиентов»
