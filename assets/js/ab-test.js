...
(function () {
  ...
  const AB_TESTS = {
    hero_headline: {
      name: 'hero_headline',
      variants: {
        A: 'Освободитесь от тревоги за 8-12 сессий по доказательному методу',
        B: 'Верните контроль над своей жизнью — избавьтесь от тревоги за 2-3 месяца'
      }
    },
    cta_button_text: {
      name: 'cta_button_text',
      variants: {
        A: 'Записаться на диагностику',
        B: 'Написать в Telegram',
